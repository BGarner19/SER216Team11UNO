public class Player {
    ...
    private String playerName; // Simply 'Player 1' or 'Player 2'
    static int playerTurn; // If this is a 0, then it is player 2's turn, if
    // it is a 1, then it is player 1's turn
    ...
    public void displayHand() {
        ...
        for (int i = 0; i < handSize; ++i) {
            if (hand[i].getValue() <= 5) {
                ...
                System.out.print("[ " + hand[i].getColor() + " " + hand[i]
                    .getValue() + " ] ");
            } else {
    ...
    public void updateHandAfterPlay(int indexToRemove) {
        ...
        for (int i = 0; i < handSize; ++i) {
            if (i == (handSize - 1)) {
                ...
                newHand[i] = hand[i + 1]; // put the next card from hand into
                // the new hand
            } else {
                newHand[i] = hand[i];
            }
